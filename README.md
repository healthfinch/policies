# healthfinch HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. healthfinch helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of healthfinch or our business and change to appropriate references to your company.
...
[healthfinch.io](htts://catalyze.io), healthcare's trusted HIPAA-compliant platform.
...
* [healthfinch HIPAA Business Associate Agreement (“BAA”)](catalyze_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to healthfinch Controls](hipaa_mapping_to_catalyze_controls.md)
