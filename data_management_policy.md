...
Data backup is an important part of the day-to-day operations of healthfinch. To protect the confidentiality, integrity, and availability of ePHI, both for Catalyze and Catalyze Customers, completes backups are done daily to assure that data remains available when it needed and in case of disaster.
...
1. Perform daily snapshot backups of all systems that process, store, or transmit ePHI for healthfinch Customers, including PaaS Customers that utilize the Catalyze Backup Service
