# HIPAA Mappings to healthfinch Controls

Below is a list of HIPAA Safeguards and Requirements and the healthfinch controls in place to meet those.

| **Administrative Controls** HIPAA Rule | healthfinch Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | healthfinch Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | healthfinch Control
---------------- | ----------------
